...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        if (a == 1)
        {
            child -> alleles[0] = child -> parents[0] -> alleles[0];
            child -> alleles[1] = child -> parents[1] -> alleles[1];
        }
        else
        {
            child -> alleles[0] = child -> parents[0] -> alleles[1];
            child -> alleles[1] = child -> parents[1] -> alleles[0];
        }
